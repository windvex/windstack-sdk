...
import { PROVIDER_ERROR_CODES } from "../packages/core/dist/index.js";
import {
...
assert.equal(contract.evm.chainIdHex, vexEvm.chainIdHex);
assert.equal(contract.evm.scope, `eip155:${vexEvm.chainId}`);
